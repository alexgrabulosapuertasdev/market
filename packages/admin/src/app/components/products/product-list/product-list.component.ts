  ...
  fieldsetList: FieldSetItem[] = [
    {
      name: 'name',
      label: 'Nombre',
      placeholder: 'Indica el nombre del producto',
      type: 'text',
      required: true,
    },
    {
      ...
      type: 'select',
      selectOptions: this.productsCategories,
      required: true,
    },
    {
      name: 'description',
      label: 'Descripción',
      placeholder: 'Indica la descripción del producto',
      type: 'textarea',
      size: 'big',
      required: true,
    },
    {
      name: 'price',
      label: 'Precio',
      placeholder: 'Indica el precio del producto',
      type: 'number',
      required: true,
    },
    {
      name: 'stock',
      label: 'Cantidad',
      placeholder: 'Indica la cantidad disponible',
      type: 'number',
      required: false,
    },
    {
      name: 'image',
      label: 'Imagen',
      placeholder: 'Añade la imagen del product',
      type: 'file',
      size: 'big',
      required: true,
    },
